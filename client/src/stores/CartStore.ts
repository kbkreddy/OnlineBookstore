...
export const useCartStore = defineStore("CartStore", {
  state: () => {
    ...
    const selectedCategoryName = "Fiction";
  ...
  actions: {
    ...
    async placeOrder(customerForm: CustomerForm) {
      const useOrderDetaisStore = useOrderDetailsStore();
      useOrderDetaisStore.clearOrderDetails();
      ...
      useOrderDetaisStore.setOrderDetails(orderDetails);
    },
  },
});
